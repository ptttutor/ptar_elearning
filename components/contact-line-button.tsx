...
const LINE_URL = "https://line.me/ti/p/sjYGzkVGDL"

export function ContactLineButton({ label = "แอดไลน์ คลิกเพื่อติดต่อ", className }: { label?: string; className?: string }) {
  return (
    <a href={LINE_URL} target="_blank" rel="noopener noreferrer">
      <Button
        ...
        className={
          className ??
          "bg-[#06C755] hover:bg-[#05b24c] text-white rounded-2xl px-10 py-4 font-bold text-lg shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105"
        }
      >
