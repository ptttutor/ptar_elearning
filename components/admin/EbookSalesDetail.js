      ...
      <Row align="middle" justify="space-between" className="mb-4">
        <Col>
          <Title level={4} style={{ margin: 0 }}>
            <FileTextOutlined /> รายละเอียดยอดขาย E-book
          </Title>
        </Col>
        <Col>
          <Select
      ...
      <Spin spinning={loading}>
        {data && (
          <>
            ...
            {/* E-book ขายดี และ คำสั่งซื้อล่าสุด */}
            <Row gutter={[16, 16]}>
              <Col xs={24} xl={14}>
                <Card 
                  title={
                    <span>
                      <TrophyOutlined /> E-book ขายดี (Top 10)
                    </span>
                  }
                >
                  <Table
...
export default EbookSalesDetail;
