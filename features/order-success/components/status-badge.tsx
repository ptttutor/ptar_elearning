...
export function statusBadge(status?: string) {
  ...
  if (s === "PENDING_VERIFICATION") return <Badge className="bg-primary text-primary-foreground">รอตรวจสอบสลิป</Badge>
  if (s === "PENDING") return <Badge className="bg-secondary text-secondary-foreground">รอการชำระ</Badge>
