            ...
            >
              <CardContent className="p-0 ">
                ...
                <div className="p-6">
                  ...
                  <Link href={article.slug ? `/articles/${article.slug}` : `#`}>
                    <h3 className="text-xl font-semibold text-gray-900 mb-3 text-balance group-hover:text-primary transition-colors duration-200">
                      {article.title}
                    </h3>
                  </Link>
                  ...
                  <Button asChild variant="ghost" className="group/btn p-0 h-auto text-primary hover:text-primary/80">
